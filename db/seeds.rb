...
{"HAMBURGUESAS" =>
   {"" => [
           ...
           ["23- Mayonesa de palta y tomate", "16.00"],
           ["24- Mayonesa de palta y roquefort", "16.00"],
 ...
 "PANQUEQUES DULCES" => {
     ...
     "Con frutas rosas" => [
       ...
       ["230- Mousse de frutillas y frambuesa", "20.00"],
       ["231- Mousse de frambuesa y frutillas", "20.00"],
       ["232- Mousse de frutilla, frambuesa, cerezas, guindas, baño de chocolate y coco", "24.00"],
       ["233- Mousse de frutilla, frambuesa, cerezas, guindas y helado de vainilla (DEDICADO AL NIETO DE CARLITOS, JONY)", "26.00"],
     ],
     "Con mendicrim" => [
       ["234- Mendicrim", "14.00"],
     ...
     "Con miel" => [
       ...
       ["260- Miel y mousse de frutillas o frambuesa (A LAS CHICAS DE HOCKEY DE BANCO CIUDAD)", "19.00"],
       ["261- Miel, mousse de frutillas, guindas, cerezas, frambuesa y castañas (A JAIME TORRES)", "26.00"],
       ["262- Miel, mousse de frambuesa, guindas, cerezas, frutillas y castañas (A SOLEDAD PASTORUTTI)", "26.00"],
     ],
     "Con ricota" => [
       ["263- Ricota", "14.00"],
       ["264- Ricota y dulce de leche", "17.00"],
       ["265- Ricota y miel", "16.00"],
       ["266- Ricota, banana, castañas, miel y canela (A HOMERO MANZI)", "19.00"],
       ["267- Ricota, castañas y miel (A LUIS BERBICH Y SU NIETO SANTIAGO BARON)", "18.00"],
       ["268- Ricota, higos y puré de manzanas", "19.00"],
       ["269- Ricota, higos, puré de manzanas y miel", "19.00"],
       ["270- Ricota, banana, baño de chocolate y coco (DEDICADO A CESAR LUIS MENOTTI)", "18.00"],
       ["271- Ricota, puré de manzanas, higos y azúcar glaseada", "20.00"],
       ["272- Ricota y baño de chocolate (A PABLO MILANES)", "17.00"],
       ["273- Ricota, higos, miel y canela", "19.00"],
